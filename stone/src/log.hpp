...
#define STONE_LOG_LEVEL(logger, level) \
    if(logger->getLevel() <= level) \
        stone::LogEventWrap(stone::LogEvent::ptr(new stone::LogEvent(logger, level, \
                        __FILE__, __LINE__, 0, stone::GetThreadId(),\
                stone::GetFiberId(), time(0), stone::Thread::GetName()))).getSS()
 ...
 */
#define STONE_LOG_WARN(logger) STONE_LOG_LEVEL(logger, stone::LogLevel::WARN)
...
#define STONE_LOG_FMT_LEVEL(logger, level, fmt, ...) \
    if(logger->getLevel() <= level) \
        stone::LogEventWrap(stone::LogEvent::ptr(new stone::LogEvent(logger, level, \
                        __FILE__, __LINE__, 0, stone::GetThreadId(),\
                stone::GetFiberId(), time(0), stone::Thread::GetName()))).getEvent()->format(fmt, __VA_ARGS__)
 ...
 */
#define STONE_LOG_FMT_WARN(logger, fmt, ...)  STONE_LOG_FMT_LEVEL(logger, stone::LogLevel::WARN, fmt, __VA_ARGS__)
