#include "article_label_rel_info.hpp"
#include "src/log.hpp"
...
int ArticleLabelRelInfoDao::Update(ArticleLabelRelInfo::ptr info, stone::IDB::ptr conn) {
...
int ArticleLabelRelInfoDao::Insert(ArticleLabelRelInfo::ptr info, stone::IDB::ptr conn) {
...
int ArticleLabelRelInfoDao::InsertOrUpdate(ArticleLabelRelInfo::ptr info, stone::IDB::ptr conn) {
    if(info->m_id == 0) {
...
int ArticleLabelRelInfoDao::Delete(ArticleLabelRelInfo::ptr info, stone::IDB::ptr conn) {
...
int ArticleLabelRelInfoDao::DeleteById( const int64_t& id, stone::IDB::ptr conn) {
    std::string sql = "delete from article_label_rel where id = ?";
    auto stmt = conn->prepare(sql);
    if(!stmt) {
        STONE_LOG_ERROR(g_logger) << "stmt=" << sql
...
int ArticleLabelRelInfoDao::DeleteByArticleId( const int64_t& article_id, stone::IDB::ptr conn) {
...
int ArticleLabelRelInfoDao::DeleteByLabelId( const int64_t& label_id, stone::IDB::ptr conn) {
    std::string sql = "delete from article_label_rel where label_id = ?";
    auto stmt = conn->prepare(sql);
    if(!stmt) {
        STONE_LOG_ERROR(g_logger) << "stmt=" << sql
                 << " errno=" << conn->getErrno() << " errstr=" << conn->getErrStr();
...
int ArticleLabelRelInfoDao::DeleteByArticleIdLabelId( const int64_t& article_id,  const int64_t& label_id, stone::IDB::ptr conn) {
...
int ArticleLabelRelInfoDao::QueryAll(std::vector<ArticleLabelRelInfo::ptr>& results, stone::IDB::ptr conn) {
...
ArticleLabelRelInfo::ptr ArticleLabelRelInfoDao::Query( const int64_t& id, stone::IDB::ptr conn) {
...
int ArticleLabelRelInfoDao::QueryByArticleId(std::vector<ArticleLabelRelInfo::ptr>& results,  const int64_t& article_id, stone::IDB::ptr conn) {
...
int ArticleLabelRelInfoDao::QueryByLabelId(std::vector<ArticleLabelRelInfo::ptr>& results,  const int64_t& label_id, stone::IDB::ptr conn) {
    std::string sql = "select id, article_id, label_id, is_deleted, create_time, update_time from article_label_rel where label_id = ?";
    auto stmt = conn->prepare(sql);
    if(!stmt) {
        STONE_LOG_ERROR(g_logger) << "stmt=" << sql
                 << " errno=" << conn->getErrno() << " errstr=" << conn->getErrStr();
...
ArticleLabelRelInfo::ptr ArticleLabelRelInfoDao::QueryByArticleIdLabelId( const int64_t& article_id,  const int64_t& label_id, stone::IDB::ptr conn) {
...
int ArticleLabelRelInfoDao::CreateTableSQLite3(stone::IDB::ptr conn) {
    return conn->execute("CREATE TABLE article_label_rel("
            ...
            "CREATE INDEX article_label_rel_article_id ON article_label_rel(article_id);"
            "CREATE INDEX article_label_rel_label_id ON article_label_rel(label_id);"
            "CREATE UNIQUE INDEX article_label_rel_article_id_label_id ON article_label_rel(article_id,label_id);"
            );
}

int ArticleLabelRelInfoDao::CreateTableMySQL(stone::IDB::ptr conn) {
    return conn->execute("CREATE TABLE article_label_rel("
            ...
            "KEY `article_label_rel_label_id` (`label_id`),"
            "UNIQUE KEY `article_label_rel_article_id_label_id` (`article_id`,`label_id`)) COMMENT='文章标签关系表'");
}
} //namespace data
} //namespace blog
